...
function Counter() {
  return (
    <>
      <div className="flex flex-col md:flex-row justify-center md:w-[90%] w-[95%] mt-16 mb-16 m-auto rounded-2xl md:space-x-[90px]">
        <div className="flex flex-col items-center mt-12 md:mb-12">
          <div className="flex items-center justify-center w-40 h-40 rounded-full  border-dashed  border-4 border-blue-500 ">
